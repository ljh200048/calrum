    ...
    return (
      <div className="max-w-md mx-auto my-20 p-8 bg-white border border-stone-200 rounded-2xl text-center shadow-xs">
        ...
        <p className="text-xs text-stone-600 mb-6 leading-relaxed">
          이 페이지는 관리자 계정으로 로그인한 경우에만 접근할 수 있습니다. 로그인 페이지에서 최고 관리자 계정으로 로그인해 주세요.
        </p>
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            to="/"
            className="inline-flex px-4 py-2 rounded-lg border border-stone-300 text-stone-700 text-xs font-semibold hover:bg-stone-100"
          >
            홈으로 이동
          </Link>
        </div>
